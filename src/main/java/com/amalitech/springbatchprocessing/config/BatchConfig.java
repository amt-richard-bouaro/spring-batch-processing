...
public class BatchConfig {
    ...
    public JsonItemReader<UserEntity> jsonItemReader(ObjectMapper objectMapper) {
        JacksonJsonObjectReader<UserEntity> jsonObjectReader = new JacksonJsonObjectReader<>(UserEntity.class);
        jsonObjectReader.setMapper(objectMapper);
        
        return new JsonItemReader<>(new FileSystemResource("src/main/resources/MOCK_DATA.json"), jsonObjectReader);
    }
